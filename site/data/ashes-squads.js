export const ASHES_SQUADS = [
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Adam Gilchrist", roles: ["Wicketkeeper"], batting: 91, bowling: 5, fielding: 84, experience: 95 },
      { name: "Shane Watson", roles: ["All-rounder"], batting: 83, bowling: 72, fielding: 85, experience: 80 },
      { name: "Shane Warne", roles: ["Spinner"], batting: 30, bowling: 92, fielding: 74, experience: 99 },
      { name: "Glenn McGrath", roles: ["Fast Bowler"], batting: 15, bowling: 88, fielding: 88, experience: 97 },
      { name: "Brett Lee", roles: ["Fast Bowler"], batting: 20, bowling: 86, fielding: 86, experience: 93 },
      { name: "Jason Gillespie", roles: ["Fast Bowler"], batting: 16, bowling: 84, fielding: 83, experience: 88 },
  ...
  },
  {
    ...
    year: 2013,
    players: [
      { name: "David Warner", roles: ["Opener"], batting: 89, bowling: 8, fielding: 75, experience: 90 },
      ...
      { name: "Steve Smith", roles: ["Middle Order"], batting: 88, bowling: 18, fielding: 89, experience: 87 },
      { name: "Shane Watson", roles: ["All-rounder"], batting: 82, bowling: 70, fielding: 83, experience: 84 },
      { name: "Brad Haddin", roles: ["Wicketkeeper"], batting: 78, bowling: 7, fielding: 86, experience: 88 },
      { name: "Ashton Agar", roles: ["All-rounder", "Spinner"], batting: 72, bowling: 68, fielding: 78, experience: 70 },
      ...
      { name: "Ryan Harris", roles: ["Fast Bowler"], batting: 16, bowling: 83, fielding: 81, experience: 89 },
  ...
  },
  {
    ...
    players: [
      ...
      { name: "David Warner", roles: ["Opener"], batting: 86, bowling: 5, fielding: 78, experience: 89 },
      ...
      { name: "Alex Carey", roles: ["Wicketkeeper"], batting: 79, bowling: 20, fielding: 88, experience: 80 },
      { name: "Cameron Green", roles: ["All-rounder"], batting: 84, bowling: 74, fielding: 86, experience: 83 },
      ...
      { name: "Scott Boland", roles: ["Fast Bowler"], batting: 18, bowling: 83, fielding: 82, experience: 82 },
    ],
  },
  {
    id: "eng-2023",
    ...
    year: 2023,
    players: [
      { name: "Zak Crawley", roles: ["Opener"], batting: 84, bowling: 8, fielding: 74, experience: 78 },
      { name: "Ben Duckett", roles: ["Opener"], batting: 83, bowling: 5, fielding: 77, experience: 77 },
      { name: "Ollie Pope", roles: ["Top Order"], batting: 88, bowling: 8, fielding: 81, experience: 82 },
      { name: "Joe Root", roles: ["Middle Order"], batting: 92, bowling: 15, fielding: 88, experience: 96 },
      { name: "Harry Brook", roles: ["Middle Order"], batting: 90, bowling: 10, fielding: 84, experience: 85 },
      { name: "Ben Stokes", roles: ["All-rounder"], batting: 89, bowling: 78, fielding: 86, experience: 92 },
      { name: "Jonny Bairstow", roles: ["Wicketkeeper"], batting: 81, bowling: 12, fielding: 83, experience: 79 },
      ...
      { name: "Josh Tongue", roles: ["Fast Bowler"], batting: 14, bowling: 82, fielding: 80, experience: 74 },
    ],
  },
  {
    id: "aus-2019",
    ...
    year: 2019,
    players: [
      { name: "David Warner", roles: ["Opener"], batting: 90, bowling: 4, fielding: 78, experience: 92 },
      ...
      { name: "Steve Smith", roles: ["Middle Order"], batting: 95, bowling: 16, fielding: 92, experience: 96 },
      { name: "Travis Head", roles: ["Middle Order"], batting: 84, bowling: 18, fielding: 83, experience: 80 },
      { name: "Matthew Wade", roles: ["Wicketkeeper", "Middle Order"], batting: 77, bowling: 6, fielding: 85, experience: 78 },
      { name: "Cameron Green", roles: ["All-rounder"], batting: 82, bowling: 72, fielding: 84, experience: 74 },
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Jason Roy", roles: ["Opener"], batting: 80, bowling: 3, fielding: 76, experience: 72 },
      ...
      { name: "Ben Stokes", roles: ["All-rounder"], batting: 91, bowling: 79, fielding: 88, experience: 93 },
      { name: "Jos Buttler", roles: ["Wicketkeeper"], batting: 86, bowling: 4, fielding: 85, experience: 86 },
      { name: "Moeen Ali", roles: ["All-rounder", "Spinner"], batting: 83, bowling: 76, fielding: 82, experience: 84 },
      { name: "Jack Leach", roles: ["Spinner"], batting: 31, bowling: 83, fielding: 79, experience: 73 },
      { name: "Jofra Archer", roles: ["Fast Bowler"], batting: 24, bowling: 87, fielding: 86, experience: 78 },
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Steve Waugh", roles: ["Middle Order", "All-rounder"], batting: 83, bowling: 22, fielding: 86, experience: 86 },
      { name: "Ian Healy", roles: ["Wicketkeeper"], batting: 70, bowling: 0, fielding: 88, experience: 82 },
      { name: "Simon O'Donnell", roles: ["All-rounder"], batting: 75, bowling: 72, fielding: 79, experience: 80 },
      { name: "Shane Warne", roles: ["Spinner"], batting: 26, bowling: 90, fielding: 74, experience: 68 },
      ...
      { name: "Terry Alderman", roles: ["Fast Bowler"], batting: 11, bowling: 81, fielding: 72, experience: 85 },
    ],
  },
  {
    id: "eng-1989",
    ...
    players: [
      ...
      { name: "Allan Border", roles: ["Middle Order"], batting: 80, bowling: 12, fielding: 85, experience: 92 },
      ...
      { name: "Devin Malcolm", roles: ["Fast Bowler"], batting: 14, bowling: 83, fielding: 74, experience: 76 },
      ...
      { name: "Derek Pringle", roles: ["Fast Bowler"], batting: 16, bowling: 77, fielding: 75, experience: 83 },
    ],
  },
  {
    id: "aus-1981",
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Jeff Thomson", roles: ["Fast Bowler"], batting: 16, bowling: 89, fielding: 77, experience: 84 },
      { name: "Max Walker", roles: ["Fast Bowler", "All-rounder"], batting: 64, bowling: 81, fielding: 78, experience: 79 },
      { name: "John Edrich", roles: ["Opener"], batting: 82, bowling: 6, fielding: 77, experience: 80 },
      { name: "Keith Stackpole", roles: ["Opener"], batting: 81, bowling: 5, fielding: 78, experience: 82 },
      { name: "Bob Massie", roles: ["Fast Bowler"], batting: 15, bowling: 82, fielding: 74, experience: 76 },
      { name: "Alan Turner", roles: ["Middle Order"], batting: 76, bowling: 10, fielding: 80, experience: 70 },
    ],
  },
  {
    id: "eng-1961",
    ...
    players: [
      ...
      { name: "Middlesex Wicketkeeper", roles: ["Wicketkeeper"], batting: 68, bowling: 0, fielding: 88, experience: 80 },
      ...
      { name: "Graham Thorpe", roles: ["Top Order"], batting: 80, bowling: 6, fielding: 82, experience: 72 },
      { name: "Tom Graveney", roles: ["Middle Order"], batting: 84, bowling: 4, fielding: 80, experience: 88 },
      { name: "Ken Barrington", roles: ["Opener"], batting: 85, bowling: 4, fielding: 79, experience: 89 },
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Ken Mackay", roles: ["Fast Bowler"], batting: 16, bowling: 84, fielding: 76, experience: 86 },
      { name: "Wicketkeeper Ron", roles: ["Wicketkeeper"], batting: 66, bowling: 0, fielding: 89, experience: 79 },
      { name: "Sam Loxton", roles: ["Middle Order"], batting: 79, bowling: 56, fielding: 80, experience: 84 },
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Bill Ponsford", roles: ["Opener"], batting: 88, bowling: 4, fielding: 80, experience: 90 },
      { name: "Vic Richardson", roles: ["Middle Order"], batting: 83, bowling: 22, fielding: 82, experience: 88 },
      { name: "Stan McCabe", roles: ["Middle Order"], batting: 86, bowling: 10, fielding: 84, experience: 89 },
      { name: "Wicketkeeper Bert", roles: ["Wicketkeeper"], batting: 68, bowling: 0, fielding: 88, experience: 80 },
      ...
      { name: "Eddie Gilbert", roles: ["Fast Bowler"], batting: 14, bowling: 84, fielding: 72, experience: 78 },
      ...
      { name: "Harry Alexander", roles: ["Fast Bowler"], batting: 10, bowling: 79, fielding: 70, experience: 76 },
      { name: "Jack Ryder", roles: ["Middle Order"], batting: 80, bowling: 12, fielding: 81, experience: 84 },
    ],
  },
  {
    id: "eng-1926",
  ...
  },
  {
    ...
    players: [
      ...
      { name: "Syd Gregory", roles: ["Opener"], batting: 84, bowling: 6, fielding: 82, experience: 88 },
      ...
      { name: "Wicketkeeper Sammy", roles: ["Wicketkeeper"], batting: 68, bowling: 0, fielding: 89, experience: 84 },
      { name: "Charlie Macartney", roles: ["Middle Order"], batting: 85, bowling: 14, fielding: 81, experience: 86 },
      { name: "Bill Howell", roles: ["Fast Bowler"], batting: 16, bowling: 84, fielding: 72, experience: 83 },
      ...
      { name: "Ernie Jones", roles: ["Fast Bowler"], batting: 12, bowling: 80, fielding: 70, experience: 76 },
      { name: "Charlie Kelleway", roles: ["Middle Order"], batting: 78, bowling: 12, fielding: 79, experience: 81 },
      { name: "Reggie Duff", roles: ["Opener"], batting: 82, bowling: 6, fielding: 77, experience: 79 },
    ],
  },
  {
    id: "eng-1902",
