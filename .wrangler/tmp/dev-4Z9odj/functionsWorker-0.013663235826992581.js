...
// .wrangler/tmp/pages-0pYtmQ/functionsWorker-0.013663235826992581.mjs
...
__name2(sortSquadPlayers, "sortSquadPlayers");
...
__name2(normalizeSquad, "normalizeSquad");
...
__name2(normalizePlayableMode, "normalizePlayableMode");
...
__name2(sanitizePlainText, "sanitizePlainText");
...
__name2(stablePlayerIdFromName, "stablePlayerIdFromName");
...
__name2(buildCatalogFromSquads, "buildCatalogFromSquads");
...
__name2(slotAcceptsPlayer, "slotAcceptsPlayer");
...
__name2(playerOverall, "playerOverall");
...
__name2(playerSlotScore, "playerSlotScore");
...
__name2(lineupIdsToPlayers, "lineupIdsToPlayers");
...
__name2(validateLineupPlayerIds, "validateLineupPlayerIds");
...
__name2(assignBestValidLineup, "assignBestValidLineup");
...
__name2(methodNotAllowed, "methodNotAllowed");
...
__name2(weightedPick, "weightedPick");
function pluralize(value, singular, plural = `${singular}s`) {
  return value === 1 ? singular : plural;
}
__name(pluralize, "pluralize");
__name2(pluralize, "pluralize");
...
__name2(lineupScore, "lineupScore");
...
__name2(gradeFromOverall, "gradeFromOverall");
...
__name2(teamMetricsFromLineup, "teamMetricsFromLineup");
...
__name2(ballsToOvers, "ballsToOvers");
...
__name2(teamBowlingRanking, "teamBowlingRanking");
...
__name2(teamBattingRanking, "teamBattingRanking");
...
__name2(battingOrder, "battingOrder");
...
__name2(sampleBatterScore, "sampleBatterScore");
...
__name2(shouldDeclare, "shouldDeclare");
...
__name2(buildBattingScorecard, "buildBattingScorecard");
...
__name2(buildBowlingScorecard, "buildBowlingScorecard");
...
__name2(buildInningsSummary, "buildInningsSummary");
...
__name2(bestBattersFromInnings, "bestBattersFromInnings");
...
__name2(bestBowlerFromInnings, "bestBowlerFromInnings");
...
__name2(buildMatchBoxScore, "buildMatchBoxScore");
...
__name2(generateHeadline, "generateHeadline");
...
__name2(matchMarginText, "matchMarginText");
...
__name2(performancePointsForCard, "performancePointsForCard");
function collectSeriesStats(series) {
  const leaderMap = /* @__PURE__ */ new Map();
  const addCardStats = /* @__PURE__ */ __name2((side, card) => {
  ...
  const addBowlerStats = /* @__PURE__ */ __name2((side, bowler) => {
  ...
  const addInningsStats = /* @__PURE__ */ __name2((battingSide, bowlingSide, innings) => {
    if (!innings) return;
...
__name2(collectSeriesStats, "collectSeriesStats");
...
__name2(simulateDeterministicTestMatch, "simulateDeterministicTestMatch");
...
__name2(buildSingleTestSeries, "buildSingleTestSeries");
...
__name2(challengeIdForDate, "challengeIdForDate");
...
__name(createSeededRandom2, "createSeededRandom2");
__name2(createSeededRandom2, "createSeededRandom");
...
__name(weightedPick2, "weightedPick2");
__name2(weightedPick2, "weightedPick");
...
__name2(stableDateText, "stableDateText");
...
__name2(rollEligibleCandidates, "rollEligibleCandidates");
...
__name2(pickFixedAssignments, "pickFixedAssignments");
...
__name2(pickRollPlayersForSquad, "pickRollPlayersForSquad");
...
__name2(pickDailyRolls, "pickDailyRolls");
...
__name2(pickOppositionStableIds, "pickOppositionStableIds");
...
__name2(pickDailyConditions, "pickDailyConditions");
...
__name2(buildChallengeDefinition, "buildChallengeDefinition");
...
__name2(completionStateKey, "completionStateKey");
function getCompletionSolver(definition) {
  ...
  __name2(hasPathFromSelections, "hasPathFromSelections");
  return hasPathFromSelections;
}
__name(getCompletionSolver, "getCompletionSolver");
__name2(getCompletionSolver, "getCompletionSolver");
...
__name2(validateGeneratedDailyDefinition, "validateGeneratedDailyDefinition");
...
__name2(buildGeneratedChallenge, "buildGeneratedChallenge");
...
__name2(getDailyChallengeById, "getDailyChallengeById");
...
__name2(getCurrentDailyChallenge, "getCurrentDailyChallenge");
...
__name2(resolveBestAshesPlayer, "resolveBestAshesPlayer");
...
__name2(resolveSquadPlayer, "resolveSquadPlayer");
...
__name2(getDailyFixedPlayers, "getDailyFixedPlayers");
...
__name2(getDailyOppositionPlayers, "getDailyOppositionPlayers");
...
__name2(getDailyRoll, "getDailyRoll");
...
__name2(normalizeDailySelections, "normalizeDailySelections");
...
__name2(lockedStableIds, "lockedStableIds");
...
__name2(openSlotIndexesForSelections, "openSlotIndexesForSelections");
...
__name2(buildDailyPlayerPool, "buildDailyPlayerPool");
...
__name2(buildDailyCompletedXI, "buildDailyCompletedXI");
...
__name2(validSlotIndexesForPlayer, "validSlotIndexesForPlayer");
...
__name2(canSelectDailyPlayer, "canSelectDailyPlayer");
...
__name2(getVisiblePlayersForRoll, "getVisiblePlayersForRoll");
...
__name2(buildDailyRollPublicState, "buildDailyRollPublicState");
...
__name2(buildDailyRecap, "buildDailyRecap");
...
__name2(selectionOrderKey, "selectionOrderKey");
...
__name2(laterRoleOptions, "laterRoleOptions");
...
__name2(normalizeLeaderboardName, "normalizeLeaderboardName");
...
__name2(parseWinMargin, "parseWinMargin");
...
__name2(buildDailyResultsLeaderboard, "buildDailyResultsLeaderboard");
...
__name2(buildDailyCommunityStats, "buildDailyCommunityStats");
...
__name2(buildDailyChallengeSummary, "buildDailyChallengeSummary");
...
__name2(countDailyCompletionPaths, "countDailyCompletionPaths");
...
__name2(asAttemptError, "asAttemptError");
...
__name2(validateSubmissionKey, "validateSubmissionKey");
...
__name2(validateDailyParticipantId, "validateDailyParticipantId");
...
__name2(validateDailyStartPayload, "validateDailyStartPayload");
...
__name2(validateDailySelectPayload, "validateDailySelectPayload");
...
__name2(validateDailySimulatePayload, "validateDailySimulatePayload");
...
__name2(assertDailyAttemptOwnership, "assertDailyAttemptOwnership");
...
__name2(buildLockedSelectionsPayload, "buildLockedSelectionsPayload");
...
__name2(buildCompletedXiPayload, "buildCompletedXiPayload");
...
__name2(buildDailyAttemptResponse, "buildDailyAttemptResponse");
...
__name2(buildDailySimulationResult, "buildDailySimulationResult");
...
__name2(assertSelectableDailyPlayer, "assertSelectableDailyPlayer");
...
__name2(randomUrlSafeToken, "randomUrlSafeToken");
...
__name2(buildTeamRecord, "buildTeamRecord");
...
__name2(buildChallengeRecord, "buildChallengeRecord");
...
__name2(buildResultRecord, "buildResultRecord");
...
__name2(fetchTeamBySubmissionKey, "fetchTeamBySubmissionKey");
...
__name2(fetchChallengeBySubmissionKey, "fetchChallengeBySubmissionKey");
...
__name2(fetchChallengeByCreatorTeamId, "fetchChallengeByCreatorTeamId");
...
__name2(fetchResultBySubmissionKey, "fetchResultBySubmissionKey");
...
__name2(fetchResultByResponderTeamId, "fetchResultByResponderTeamId");
...
__name2(fetchChallengeDetails, "fetchChallengeDetails");
...
__name2(fetchResultDetails, "fetchResultDetails");
...
__name2(createUniquePublicId, "createUniquePublicId");
...
__name2(createChallenge, "createChallenge");
...
__name2(createSoloTeam, "createSoloTeam");
...
__name2(createResult, "createResult");
function isoTimestamp() {
  return (/* @__PURE__ */ new Date()).toISOString();
}
__name(isoTimestamp, "isoTimestamp");
__name2(isoTimestamp, "isoTimestamp");
...
__name2(tableColumnNames, "tableColumnNames");
...
__name2(ensureDailyStoreColumns, "ensureDailyStoreColumns");
...
__name2(ensureDailyStoreSchema, "ensureDailyStoreSchema");
...
__name2(buildDailyAttemptRecord, "buildDailyAttemptRecord");
...
__name2(buildDailySelectionRecord, "buildDailySelectionRecord");
...
__name2(fetchDailyAttemptById, "fetchDailyAttemptById");
...
__name2(fetchRankedDailyAttemptByParticipant, "fetchRankedDailyAttemptByParticipant");
...
__name2(listDailySelectionsForAttempt, "listDailySelectionsForAttempt");
...
__name2(fetchDailyAttemptState, "fetchDailyAttemptState");
...
__name2(createDailyAttempt, "createDailyAttempt");
...
__name2(createOrFetchRankedDailyAttempt, "createOrFetchRankedDailyAttempt");
...
__name2(addDailySelection, "addDailySelection");
...
__name2(updateDailyAttemptDisplayName, "updateDailyAttemptDisplayName");
...
__name2(updateDailyAttemptProgress, "updateDailyAttemptProgress");
...
__name2(saveDailyAttemptResult, "saveDailyAttemptResult");
...
__name2(listCompletedRankedDailyAttempts, "listCompletedRankedDailyAttempts");
...
__name2(extractClientKey, "extractClientKey");
...
__name2(sweepExpiredBuckets, "sweepExpiredBuckets");
...
__name2(asBoundedInteger, "asBoundedInteger");
...
__name2(ensurePlainObject, "ensurePlainObject");
...
__name(validateSubmissionKey2, "validateSubmissionKey2");
__name2(validateSubmissionKey2, "validateSubmissionKey");
...
__name2(sanitizeResultBox, "sanitizeResultBox");
...
__name2(sanitizeLeaderSnapshot, "sanitizeLeaderSnapshot");
...
__name2(sanitizeResultMatch, "sanitizeResultMatch");
...
__name2(validateTeamPayload, "validateTeamPayload");
...
__name2(validateChallengeCreationPayload, "validateChallengeCreationPayload");
...
__name2(validateSoloTeamPayload, "validateSoloTeamPayload");
...
__name2(validateResultCreationPayload, "validateResultCreationPayload");
...
__name2(isLocalPagesRequest, "isLocalPagesRequest");
...
__name2(proxyCanonicalLeaderboard, "proxyCanonicalLeaderboard");
...
__name2(buildFilters, "buildFilters");
...
__name2(readPayload, "readPayload");
...
__name2(buildForwardBody, "buildForwardBody");
...
__name2(canonicalUrlForPageKey, "canonicalUrlForPageKey");
...
__name2(escapeBootstrapJson, "escapeBootstrapJson");
...
__name2(replaceOrInsert, "replaceOrInsert");
...
__name2(buildBootstrapScript, "buildBootstrapScript");
...
__name2(replaceElementInnerHtml, "replaceElementInnerHtml");
...
__name2(replaceElementText, "replaceElementText");
...
__name2(retagElement, "retagElement");
...
__name2(setElementHidden, "setElementHidden");
...
__name2(setBodyAttribute, "setBodyAttribute");
...
__name2(renderSpaPage, "renderSpaPage");
...
__name2(todayLongDate, "todayLongDate");
...
__name2(breadcrumbStructuredData, "breadcrumbStructuredData");
...
__name2(websiteStructuredData, "websiteStructuredData");
...
__name2(applyBaseView, "applyBaseView");
...
__name2(applyHomeLanding, "applyHomeLanding");
...
__name2(applyDailyLanding, "applyDailyLanding");
...
__name2(applyLeaderboardLanding, "applyLeaderboardLanding");
...
__name2(applyHowToPlayLanding, "applyHowToPlayLanding");
...
__name2(applyAboutLanding, "applyAboutLanding");
...
__name2(applyWorldCupLanding, "applyWorldCupLanding");
...
__name2(applyAshesLanding, "applyAshesLanding");
...
__name2(applyHomepage, "applyHomepage");
...
__name2(applyChallengeLanding, "applyChallengeLanding");
...
__name2(pageHtmlTransform, "pageHtmlTransform");
...
__name2(pageBootstrap, "pageBootstrap");
...
__name2(renderPublicPage, "renderPublicPage");
...
// .wrangler/tmp/bundle-ZI4ecN/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZI4ecN/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.013663235826992581.js.map
