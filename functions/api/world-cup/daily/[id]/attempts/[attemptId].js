...
import { assertDailyAttemptOwnership, buildDailyAttemptResponse, validateDailyParticipantId } from "../../../../../_lib/daily-worldcup.js";
...
export async function onRequestGet(context) {
  ...
  try {
    ...
    return errorResponse(error.status ?? 400, error instanceof Error ? error.message : "Could not load the World Cup daily attempt.");
  }
}
